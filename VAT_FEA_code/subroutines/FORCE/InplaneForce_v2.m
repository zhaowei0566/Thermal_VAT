...
function Inplane_F=InplaneForce_v2(FEM,Stru,type,alpha)

% v1. consider top and right edges have same number of nodes
% v2. consider top and right edges have different number of nodes
