function [stress,strain]=StressRecoveryPlate_VAT_center_average_constant(FEM,Laminate,Mat,Stru,T0T1,center,width)
...
% %                 t0 t1];
            ...
            stress0(:,gauss_point_num)=QthetaK([1 2 5],[1 2 5])*strain0(:,gauss_point_num);
...
%         size(stress0)
        ...
        stress(elem,:,layer) =  sum(stress0,2)'/gauss_point_num;
        strain(elem,:,layer)=   sum(strain0,2)'/gauss_point_num;
