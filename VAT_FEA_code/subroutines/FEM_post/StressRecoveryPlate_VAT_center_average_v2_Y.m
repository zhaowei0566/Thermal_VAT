function [stress_global,strain_global]=StressRecoveryPlate_VAT_center_average_v2_Y(FEM,Laminate,Mat,Stru,T0T1,center,physical_length)
...
disp ( ' ======== P L A T E    S T R E S S      R E C O V E R Y ==========');
...
%               GaussLocations = [0 0]; GaussWeights = 1;
        ...
        for gauss_point_num=1:size(GaussWeights,1)
            ...
            theta = VAT_fiber_ply_angle_1D(T0,T1,centerY,center,physical_length);
