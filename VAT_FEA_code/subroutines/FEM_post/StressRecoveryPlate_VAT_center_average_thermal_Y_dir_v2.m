function [stress_global,strain_global]=StressRecoveryPlate_VAT_center_average_thermal_Y_dir_v2(FEM,...
...
%               Element_center_Y = sum(FEM.nodeCoordinates_label( NodeIndices,3))/length( NodeIndices);
            ...
            theta = VAT_fiber_ply_angle_1D(T0,T1,centerY,center,width);
