function [stress,strain]=StressRecoveryPlate_VAT_center(FEM,Laminate,Mat,Stru,T01,center,width)
...
%            [GaussWeights,GaussLocations]=gaussQuadrature(FEM.GaussPointBend);
        ...
        NormalStrain=sum(NormalStrain,2)/gauss_point_num;
        Curvature0 = sum( Curvature0,2)/gauss_point_num;
        ...
        stress(elem,1:3,layer)=QthetaK([1 2 5],[1 2 5])*strain0;
